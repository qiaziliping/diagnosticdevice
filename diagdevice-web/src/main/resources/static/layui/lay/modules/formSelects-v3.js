 ...
 * https://faysunshine.com/layui/template/index.html        // 调用方式
 */
(function(layui, window, factory) {
    ...
    var $ = layui.jquery || $,
        ...
        commons = {
            ...
            methods: {
                init: function init(options, repeat) {
                ...
                typeHandler: function typeHandler(options, dd, isAdd) {
                    ...
                    var _ref3 = [commons.methods.getValues(options), commons.methods.getIpt(options)],
                        vals = _ref3[0],
                        ipt = _ref3[1];

                    if (!vals.length) {
                        var tips = 'fsw="' + options.name + '"';
                        var _span = $('<span ' + tips + ' class="xm-select-empty">\u8BF7\u9009\u62E9</span>');
                        _span.css(styles.inputEmpty);
                        ipt.append(_span);
                    } else {
